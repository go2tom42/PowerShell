...
$path = 'y:\media\HDD\Downloads\completed\aria2\knittingreferencelibrary_collection\'
...
foreach ($File in $Files) {
    ...
    if ($hashFromFile.hash -eq $md5) {
        ...
        $ImageFiles = Get-ChildItem $tempfolder | Where-Object { $_.Extension -match 'tif|png|jpg' }
